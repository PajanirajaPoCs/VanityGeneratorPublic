...
def generateVanities(event):
    try:
        ...
        # Camparing with English Dictionary
        ...
        if len(listVanity) > 0 :
            ...
            ListOfVanity =  "Sorry, There is no vanity option for your number."
            
        #print(ListOfVanity)
        return{ "varFromLambda1":ListOfVanity}
...
def lambda_handler(event, context):
    ...
    varFromLambda = generateVanities(event)
    
    return varFromLambda
